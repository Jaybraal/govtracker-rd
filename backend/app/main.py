...
from .api.routes import contracts, companies, institutions, loans, graph, alerts, ai_chat, export, etl, intelligence, cooperatives, banks, political_parties, legislators, nominas, seguros, pgr, comisiones, gasto_ejecutado
...
app.include_router(gasto_ejecutado.router,   prefix="/api")
